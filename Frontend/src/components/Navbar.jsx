...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`dark:bg-slate-900 dark:text-white  max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${stciky ?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-850 dark:text-white duration-300 transition-all ease-in-out" :""}`}>
